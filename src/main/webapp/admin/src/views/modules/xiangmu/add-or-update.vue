    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="项目原价" prop="xiangmuOldMoney">
                       <el-input v-model="ruleForm.xiangmuOldMoney"
                                 placeholder="项目原价" clearable  :readonly="ro.xiangmuOldMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="项目原价" prop="xiangmuOldMoney">
                           <el-input v-model="ruleForm.xiangmuOldMoney"
                                     placeholder="项目原价" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现价" prop="xiangmuNewMoney">
                       <el-input v-model="ruleForm.xiangmuNewMoney"
                                 placeholder="现价" clearable  :readonly="ro.xiangmuNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="现价" prop="xiangmuNewMoney">
                           <el-input v-model="ruleForm.xiangmuNewMoney"
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    xiangmuPhoto: false,
                    xiangmuTypes: false,
                    xiangmuOldMoney: false,
                    xiangmuNewMoney: false,
                    xiangmuClicknum: false,
                ...
                rules: {
                   ...
                   xiangmuOldMoney: [
                              { required: true, message: '项目原价不能为空', trigger: 'blur' },
