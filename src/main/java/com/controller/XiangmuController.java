    ...
    */
    ...
    public R save(@RequestBody XiangmuEntity xiangmu, HttpServletRequest request){
        ...
        Wrapper<XiangmuEntity> queryWrapper = new EntityWrapper<XiangmuEntity>()
            ...
            .eq("xiangmu_clicknum", xiangmu.getXiangmuClicknum())
            .eq("shangxia_types", xiangmu.getShangxiaTypes())
        ...
        if(xiangmuEntity==null){
            xiangmu.setXiangmuClicknum(1);
            xiangmu.setShangxiaTypes(1);
...
//                            xiangmuEntity.setXiangmuOldMoney(data.get(0));                    //项目原价 要改的
//                            xiangmuEntity.setXiangmuNewMoney(data.get(0));                    //现价 要改的
//                            xiangmuEntity.setXiangmuClicknum(Integer.valueOf(data.get(0)));   //热度 要改的
//                            xiangmuEntity.setXiangmuContent("");//详情和图片
//                            xiangmuEntity.setShangxiaTypes(Integer.valueOf(data.get(0)));   //是否上架 要改的
    ...
    public R detail(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        XiangmuEntity xiangmu = xiangmuService.selectById(id);
            if(xiangmu !=null){
                ...
                //点击数量加1
                xiangmu.setXiangmuClicknum(xiangmu.getXiangmuClicknum()+1);
